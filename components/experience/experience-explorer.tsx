  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-4 border-b border-white/10 pb-3">
      <div
        ...
        className="flex flex-wrap items-center gap-x-4 gap-y-1 sm:gap-x-8 sm:gap-y-2"
      >
        {filters.map((option) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative -mb-[10px] pb-2 text-[0.9rem] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent-indigo-soft/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:-mb-[13px] sm:pb-3 sm:text-[0.92rem]",
                isActive
